local keymap = {
  ...
  { "n", "<leader>b", "<CMD> Telescope buffers<CR>",              { desc = "" } },
  ...
  { "n", "ge",
    "<CMD>lua vim.diagnostic.open_float({source=true,severity_sort=true}) <CR>", { desc = "" }
  },
  ...
  { "n",          '<A-1>',   '<CMD>BufferLineGoToBuffer 1<CR>',                   { desc = "" } },
  { "n",          '<A-2>',   '<CMD>BufferLineGoToBuffer 2<CR>',                   { desc = "" } },
  { "n",          '<A-3>',   '<CMD>BufferLineGoToBuffer 3<CR>',                   { desc = "" } },
  { "n",          '<A-4>',   '<CMD>BufferLineGoToBuffer 4<CR>',                   { desc = "" } },
  { "n",          '<A-5>',   '<CMD>BufferLineGoToBuffer 5<CR>',                   { desc = "" } },
  { "n",          '<A-6>',   '<CMD>BufferLineGoToBuffer 6<CR>',                   { desc = "" } },
  { "n",          '<A-7>',   '<CMD>BufferLineGoToBuffer 7<CR>',                   { desc = "" } },
  { "n",          '<A-8>',   '<CMD>BufferLineGoToBuffer 8<CR>',                   { desc = "" } },
  { "n",          '<A-9>',   '<CMD>BufferLineGoToBuffer 9<CR>',                   { desc = "" } },
